...
<body class="bg-dark" data-bs-scrollspy="scroll" data-bs-target=".navbar">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-white" href="iphone.php"><i class="fa-solid fa-mobile-screen"></i> iPhone Cases</a>
                    </li>
                    <li class="nav-item">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/hero_iphone.png" class="car d-block w-100" alt="hero2">
    ...
    <!-- Main Content -->
    <div class="container">
        <h2 class="text-white text-center mt-4">iPhone Phone Cases</h2>
        ...
        ?>
                <div class="col-lg-3 col-md-6 float-start">
                    <form method="post" action="samsung.php?action=add&SAMSUNG_ID=<?php echo $row["IPHONE_ID"]; ?>">
                        ...
                        <div class="row justify-content-center ">
                            <div class="card-banner m-3">
                                <div class="card  shadow m-4">
                                    <div class="inner ">
                                        <img src="image/<?php echo $row["IPHONE_IMAGE"]; ?>" class="card-img-top" />
                                    </div>
                                    <div class="card-body text-center ">
                                        <h5 class="text-dark"><?php echo $row["IPHONE_TYPE"]; ?></i>
                                        </h5>
                                        <input type="text" name="quantity" value="1" class="form-control" />
                                        <p class="text-danger">€ <?php echo $row["IPHONE_PRICE"]; ?></p>
                                        <input type="hidden" name="hidden_name" value="<?php echo $row["IPHONE_TYPE"]; ?>" />
